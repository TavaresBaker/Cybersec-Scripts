...
# Step 5: Download fresh www directory from GitHub (RELENG_2_7_2)
fetch https://codeload.github.com/pfsense/pfsense/zip/refs/heads/RELENG_2_7_2 -o pfsense.zip

# Step 6: Unzip and replace www
unzip -oq pfsense.zip
rm -rf www
cp -a pfsense-RELENG_2_7_2/src/usr/local/www .

# Step 7: Cleanup
rm -rf pfsense.zip pfsense-RELENG_2_7_2
