...
\$rule1['proto'] = "tcp";
\$rule1['source'] = "any";
\$rule1['destination'] = "1.1.1.1";
\$rule1['destinationport'] = "443";
\$rule1['action'] = "block";
\$rule1['descr'] = "Block Cloudflare DoH";
\$config['filter']['rule'][] = \$rule1;

\$rule2 = \$rule1;
\$rule2['destination'] = "8.8.8.8";
\$rule2['descr'] = "Block Google DoH";
\$config['filter']['rule'][] = \$rule2;
